...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: "بنت مريضة",
      content: "أحسن خدمة تمريض منزلي في القاهرة . الممرضة جت في المعاد وكانت شاطرة ومهتمة بماما جداً.",
      rating: 5
    },
    {
    ...
    },
    {
      ...
      role: "زوجة مريض",
      content: "شكراً لفريق شركة اغابي. جوزي كان تعبان أوي والناس دي اهتمت بيه زي أهله.",
      rating: 5
    }
  ];
