  ...
  const testimonials = [
    {
      name: "أسرة مينا جورج",
      role: "عميل راضٍ",
      content: "صراحة الخدمة كانت ممتازة جداً والممرضة كانت محترفة ومتعاملة بأدب. حسينا بالأمان مع الوالد.",
      rating: 5
    },
    {
      name: "نادية سمير فهيم",
      role: "بنت مريضة",
      content: "أحسن خدمة في القاهرة. الممرضة جت في المعاد وكانت شاطرة ومهتمة بماما جداً. ربنا يباركلهم.",
      rating: 5
    },
    {
    ...
    },
    {
      name: "جرجس عطية",
      role: "مريض سابق",
      content: " ناس محترمين أوي والخدمة فوق الممتاز. كل اللي طلبته اتعمل بكل دقة واهتمام.",
      rating: 5
    },
    {
      name: "دكتوره مريم",
      role: "طبيبة",
      content: "أنا مرتاحة معاهم جدًا، بيهتموا بالتفاصيل وبيتابعوا الحالة أول بأول باهتمام.",
      rating: 5
    },
    {
      name: "دكتوه ماريهان",
      role: "طبيبة",
      content: "اأغابي بجد شركة تستاهل الثقة، متعاونين جدًا وبيحبوا شُغلهم بشكل واضح.",
      rating: 5
    },
    {
      name: "ابونا القس كاراس",
      role: "مريض سابق",
      content: "من أول يوم حسّيت بالفرق، شُغلهم منظم وبيشتغلوا بحب مش بس واجب.",
      rating: 5
    },
    {
      name: "فادية مجدي توفيق",
      role: "زوجة مريض",
      content: "شكراً للفريق الرائع ده. جوزي كان تعبان أوي والناس دي اهتمت بيه زي أهله.",
      rating: 5
    }
  ];
