  ...
  const testimonials = [
    {
      name: "أم أحمد",
      relation: "والدة مريض",
      text: "فريق شركة اغابي كان معنا في أصعب الأوقات. الممرضة كانت محترفة جداً ومتعاطفة. شعرنا بالأمان والراحة.",
      icon: Heart,
      rating: 5
    },
    {
    ...
    },
    {
      name: "فاطمة علي",
      relation: "ابنة مسنة",
      text: "رعاية والدتي كانت في أيدٍ أمينة. الممرضة كانت صبورة ومهتمة بأدق التفاصيل. شكراً شركة اغابي.",
      icon: Cross,
      rating: 5
    },
    {
