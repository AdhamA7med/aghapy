                ...
                <div className="text-center h-full flex flex-col">
                  ...
                  <div className="space-y-3">
                    {service.link && (
                      <Link 
                        to={service.link}
                        className={`w-full bg-${service.color}/10 hover:bg-${service.color}/20 text-${service.color} font-semibold py-3 px-6 rounded-full transition-all duration-300 hover-lift block text-center`}
                      >
                        {service.title === "انضم لفريق العمل" ? "تعرف على الأوراق المطلوبة" : "تصفح المنتجات"}
                      </Link>
                    )}
                    ...
                    <a 
                      ...
                      className="w-full bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-6 rounded-full transition-all duration-300 hover-lift flex items-center justify-center gap-2"
                    >
