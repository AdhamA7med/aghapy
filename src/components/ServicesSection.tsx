...
const ServicesSection = () => {
  ...
  const handleNavigation = (path: string) => {
    // Navigate to the page and scroll to top immediately
    ...
    <section id="services" className="py-20 bg-white" role="main" aria-labelledby="services-heading">
      <div className="container mx-auto px-4">
        ...
        <header className="text-center mb-16">
          ...
          <h2 id="services-heading" className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">خدماتنا</h2>
            ...
            return (
              ...
              >
                <div className="text-center h-full flex flex-col">
                  {/* Icon */}
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-${service.color}/10 mb-6 mx-auto`} aria-hidden="true">
                  ...
                  <div className="flex-1 mb-6">
                    <ul className="text-right space-y-2" role="list">
                      {service.items.map((item, itemIndex) => (
                        <li key={itemIndex} className="text-sm text-gray-700 flex items-start" role="listitem">
                  ...
                  <div className="space-y-3">
                    {service.link && (
                      <button 
                        ...
                        aria-label={`انتقل إلى صفحة ${service.title}`}
                      >
                    ...
                    <a 
                      ...
                      aria-label={`تواصل عبر الواتساب على الرقم ${service.whatsapp}`}
                    >
